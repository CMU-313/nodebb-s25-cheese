...
Events._types = {
	...
	resolve: {
        ...
        translation: async (event, language) => translateEventArgs(event, language, 'topic:user-resolved-topic', renderUser(event), `${relative_path}${event.href}`, renderTimeago(event)),
    },
};
