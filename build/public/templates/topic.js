  ...
  function compiled(helpers, context, guard, iter, helper) {
    ...
    return "<script type=\"application/ld+json\">{\n\"@context\": \"https://schema.org\",\n\"@type\": \"BreadcrumbList\",\n\"itemListElement\": [{\n\"@type\": \"ListItem\",\n\"position\": 1,\n\"name\": \"" + 
      ...
      (guard((context != null) ? context['browsingUsers'] : null) ?
        "\n<div class=\"hidden-xs\"><!-- This partial intentionally left blank; overwritten by nodebb-plugin-browsing-users --></div>\n" :
        "") + 
      "\n</div>\n" + 
      ...
      (guard((context != null && context['config'] != null && context['config']['theme'] != null) ? context['config']['theme']['enableQuickReply'] : null) ?
        "\n" + 
          ...
          "\n" :
        "") + 
      "\n</div>\n<div class=\"pagination-block d-none d-lg-block flex-grow-1 mb-4\">\n<div class=\"d-flex justify-content-end sticky-top mt-4\" style=\"top:6rem;z-index:1;\">\n<div class=\"ps-1 ps-md-0 d-inline-block\">\n<div class=\"scroller-content d-flex gap-2 flex-column align-items-start\">\n<button class=\"pagetop btn-ghost-sm ff-secondary d-inline-flex border-0\" style=\"padding: 4px;\"><i class=\"fa fa-chevron-up\"></i> <span class=\"timeago text-xs text-muted text-nowrap\" title=\"" + 
      __escape(guard((context != null) ? context['timestampISO'] : null)) + 
      ...
      __escape(guard((context != null) ? context['url'] : null)) + 
      "\" tabindex=\"-1\" aria-disabled=\"true\" aria-label=\"[[topic:unread-posts-link]]\"></a>\n</div>\n</div>\n</div>\n<button class=\"pagebottom btn-ghost-sm ff-secondary d-inline-flex border-0\" style=\"padding: 4px;\"><i class=\"fa fa-chevron-down\"></i> <span class=\"timeago text-xs text-muted text-nowrap\" title=\"" + 
      __escape(guard((context != null) ? context['lastposttimeISO'] : null)) + 
      "\"></span></button>\n</div>\n</div>\n</div>\n</div>\n</div>\n" + 
